...
$alamat_pelanggan = QueryOnedata(
    'SELECT * FROM alamat_pelanggan WHERE id_pelanggan = ' .
        $_GET['id_pelanggan'] .
        ''
)->fetch_assoc();
        ...
        <div class='card-body'>
            <form action='<?= $url ?>/aksi/data_pelanggan.php' method='post' enctype='multipart/form-data'>
                <div class='mb-3 row' style='display: none;'>
                    ...
                    <div class='col-sm-10'>
                        <input type='number' class='form-control' id='inputid_pelanggan' name='id_pelanggan' value='<?= $_GET[
                            'id_pelanggan'
                        ] ?>' required>
                        <input type='number' class='form-control' id='inputid_alamat' name='id_alamat' value='<?= $alamat_pelanggan[
                            'id_alamat'
                        ] ?>' >
                    </div>
                </div>
                <div class='mb-3 row'>
                    ...
                    <div class='col-sm-10'>
                        <textarea class='form-control' id='inputket_alamat' name='ket_alamat' required><?= $alamat_pelanggan[
                            'ket_alamat'
                        ] ?></textarea>
                    </div>
                </div>
                <div class='mb-3 row'>
                    ...
                    <div class='col-sm-10'>
                        <textarea class='form-control' id='inputlat_alamat' name='lat_alamat' required><?= $alamat_pelanggan[
                            'lat_alamat'
                        ] ?></textarea>
                    </div>
                </div>
                <div class='mb-3 row'>
                    ...
                    <div class='col-sm-10'>
                        <textarea class='form-control' id='inputlong_alamat' name='long_alamat' required><?= $alamat_pelanggan[
                            'long_alamat'
                        ] ?></textarea>
                    </div>
                </div>
                        ...
                        <!-- <iframe src="https://www.google.com/maps?q=<?= $alamat_pelanggan['lat_alamat'] ?>,<?= $alamat_pelanggan['long_alamat'] ?>&hl=es;z=14&output=embed" frameborder="0" style='width:100%;'></iframe> -->
                            ...
                            <script>
                                function initMap() {
                                    ...
                                    var myLatLng = { lat: <?= $alamat_pelanggan['lat_alamat'] ?>, lng: <?= $alamat_pelanggan['long_alamat'] ?> }; // Jakarta example
