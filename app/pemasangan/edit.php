        ...
        <div class='card-body'>
            <form action='<?= $url ?>/aksi/pemasangan.php' method='post' enctype='multipart/form-data'>
                <div class='mb-3 row' >
                    ...
                    <div class='col-sm-10'>
                        <input type='text' class='form-control' value='<?= $pemasangan['id_pemasangan']; ?>' readonly>
                        <input type='text' class='form-control d-none' id='inputid_pemasangan' name='id_pemasangan' value='<?= $pemasangan['id_pemasangan']; ?>' required>
                    </div>
                </div>
                <div class='mb-3 row'>
                    ...
                    <div class='col-sm-10'>
                        ...
                        <select class='form-control' name='id_pelanggan' id='inputid_pelanggan'>
                            <?php
                            $pelanggans = QueryOnedata('SELECT * FROM pelanggan WHERE id_pelanggan = "'.$pemasangan['id_pelanggan'].'"')->fetch_assoc();
                            
                            ?>
                            <option value='<?= $pemasangan['id_pelanggan'] ?>'><?= $pemasangan['id_pelanggan'] ?> <?= $pelanggans['nm_pelanggan'] ?></option>
                        </select>
                    </div>
                </div>
