...
if (isset($_POST['simpanlayanan'])) {
    $data = ['id_layanan' => $_POST['id_layanan'],'nm_layanan' => $_POST['nm_layanan'], 'ket_layanan' => $_POST['ket_layanan'], 'harga_layanan' => $_POST['harga_layanan'], 'jenis_layanan' => $_POST['jenis_layanan'],];
    // Insert satu data
