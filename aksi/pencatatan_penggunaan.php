...
if (isset($_POST['simpanpencatatan_penggunaan'])) {
        ...
        if ($ukuran < 1044070) {
            ...
            if ($upload_guru) {
                $data = [
                    ...
                    'nomor_pasang' => $_POST['nomor_pasang'],
                    'nilai_stand_meter' => $_POST['nilai_stand_meter'],
                    'foto_stand_meter' => $nama_file,
                ];
                // Insert satu data
    ...
    $process = UpdateOneData(
        'pencatatan_penggunaan',
        $data,
        ' WHERE id_pencatatan ="' . $_POST['id_pencatatan'] . '"'
    );
    ...
    $process = DeleteOneData(
        'pencatatan_penggunaan',
        'WHERE id_pencatatan = "' . $_GET['id_pencatatan'] . '"'
    );
    $_SESSION['message'] = 'Data Pencatatan_Penggunaan ' . $process['message'];
    header('Location: ' . $url . '/app/pencatatan_penggunaan/index.php');
    exit();
